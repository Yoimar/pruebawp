...
<div class="images">
	...
	<?php if ( has_post_thumbnail() ) : ?>
		...
		<div class="product-image-holder big-image">
			...
			<a data-rel="prettyPhoto[product-gallery]" class="zoom" href="<?php echo wp_get_attachment_url( get_post_thumbnail_id() ); ?>" title="<?php echo get_the_title( get_post_thumbnail_id() ); ?>"><?php echo get_the_post_thumbnail( $post->ID, apply_filters( 'single_product_large_thumbnail_size', 'shop_single' ) ) ?>
