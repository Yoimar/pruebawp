	...
	extract( shortcode_atts( array(
		...
		if( $tab3 != '' ) {
			$tab3 = '<li>'. $tab3  . '<div class="tab-over">' . $tab3 . '</div></li>';
                ...
                if( $tab4 != '' ) {
			$tab4 = '<li>'. $tab4  . '<div class="tab-over">' . $tab4 . '</div></li>';
		}
                if( $tab5 != '' ) {
			$tab5 = '<li>'. $tab5  . '<div class="tab-over">' . $tab5 . '</div></li>';
		}
                if( $tab6 != '' ) {
			$tab6 = '<li>'. $tab6  . '<div class="tab-over">' . $tab6 . '</div></li>';
		}
                if( $tab7 != '' ) {
			$tab7 = '<li>'. $tab7 . '<div class="tab-over">' . $tab7 . '</div></li>';
		}
                if( $tab8 != '' ) {
			$tab8 = '<li>'. $tab8  . '<div class="tab-over">' . $tab8 . '</div></li>';
		}
                if( $tab9 != '' ) {
			$tab9 = '<li>'. $tab9  . '<div class="tab-over">' . $tab9 . '</div></li>';
		}
